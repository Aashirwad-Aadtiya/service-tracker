                  ...
                  <div key={idx} className="flex gap-2 items-start">
                    ...
                    <div className="w-2/3">
                      <input
                        ...
                        className={`bg-[#1e1b2e] p-2 rounded text-white border ${
                          !part.item ? "border-red-500" : "border-purple-700"
                        } w-full`}
                      />
                      {!part.item && (
...
<<<<<<< HEAD
                    ...
                    <div className="w-1/4">
                      <input
                        ...
                        className={`bg-[#1e1b2e] p-2 rounded text-white border ${
                          part.qty < 1 ? "border-red-500" : "border-purple-700"
                        } w-full`}
                      />
                      {part.qty < 1 && (
                        <p className="text-xs text-red-400 mt-1">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        const updated = form.parts.filter((_, i) => i !== idx);
                        setForm({ ...form, parts: updated });
                      }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (!lastPart.item.trim()) {
                      alert(
                        "Please fill out the last part name before adding another."
                      );
                      return;
                    }
...
<<<<<<< HEAD
              ...
              >
                <button
                  ...
                  className="text-red-400 hover:text-red-600 p-1 absolute top-2 right-2 rounded-full hover:bg-red-950 transition"
                  title="Delete"
                >
                  <Trash2 size={16} />
                </button>
